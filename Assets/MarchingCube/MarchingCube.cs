...
namespace MarchingCube
{
    public static class MarchingCube
    {
        ...
        // 2 : top-left
        // 3 : top-right
        // The order of two points in segment represents which side is the ground-side and the air-side.
        // seg.dir.Rot(0.5pi) is the direction from ground-side to air-side.
