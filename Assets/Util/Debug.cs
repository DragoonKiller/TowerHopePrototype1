...
{
    public static void EditorDrawRect(Vector2 pos, Vector2 size, Color color, float duration = 0f)
        => EditorDrawRect(pos, size, color, duration, Quaternion.identity);
    
    public static void EditorDrawRect(Vector2 pos, Vector2 size, Color color, float duration, Quaternion rotation)
    {
        size /= 2.0f;
    ...
    public static void EditorDrawCircle(Vector2 pos, float radius, int edgeCount, Color color, float duraction = 0f)
    {
