...
namespace MarchingCube
{
    ...
    public class Chunk : MonoBehaviour
    {
        ...
        /// Get terrains's normal that points from the ground to the air.
        /// Return null if the pos is incorrect.
        public Vector2? GetTerrainNormal(Vector2 pos)
        {
            foreach(var seg in segs)
            {
                if(seg.Cover(pos, false))
                {
                    return seg.dir.RotHalfPi();
                }
            }
            return null;
        }
