...
{
    public static void DebugDrawRect(Vector2 pos, Vector2 size, Color color, float duration)
    ...
    public static void DebugDrawCircle(Vector2 pos, float radius, int edgeCount, Color color, float duraction)
    {
